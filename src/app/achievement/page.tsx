...
function CategorySection({ title, currentStreak, nextMilestone, progress, badges, description, showIndividualProgress }) {
  return (
...
function BadgeGrid({ badges, showIndividualProgress }) {
  return (
    <TooltipProvider>
